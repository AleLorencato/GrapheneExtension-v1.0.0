...
public enum ModArmorMaterials implements ArmorMaterial {
    GRAPHENE("graphene", 31, new int[]{5, 9, 7, 4}, 25,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 3f, 0.05f, () -> Ingredient.of(ModItems.GRAPHENE.get()));
    ...
    public String getName() {
        return GrapheneExtension.MOD_ID + ":" + this.name;
    }
